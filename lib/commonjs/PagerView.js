...
class PagerView extends _react.default.PureComponent {
  ...
  componentDidMount() {
    if (this.props.initialPage) {
      ...
      _reactNative.UIManager.dispatchViewManagerCommand((0, _reactNative.findNodeHandle)(this), (0, _PagerViewNative.getViewManagerConfig)().Commands.setPage, [this.props.initialPage, false]);
    }
  }
  /**
  ...
  setPage(page, animated = true) {
    ...
    requestAnimationFrame(() => {
      _reactNative.UIManager.dispatchViewManagerCommand((0, _reactNative.findNodeHandle)(this), (0, _PagerViewNative.getViewManagerConfig)().Commands.setPage, [page, animated]);
    });
  }
  /**
   * A helper function to scroll to a specific page in the PagerView.
