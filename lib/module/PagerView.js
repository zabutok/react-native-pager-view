...
export class PagerView extends React.PureComponent {
  constructor(props) {
  ...
  componentDidMount() {
    if (this.props.initialPage) {
      ...
      UIManager.dispatchViewManagerCommand(findNodeHandle(this), getViewManagerConfig().Commands.setPage, [this.props.initialPage, false]);
    }
  }
  /**
